...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_drag = widgetDrag.widgetdrag(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_drag.sizePolicy().hasHeightForWidth())
        self.widget_drag.setSizePolicy(sizePolicy)
        self.widget_drag.setCursor(QtGui.QCursor(QtCore.Qt.OpenHandCursor))
        self.widget_drag.setObjectName("widget_drag")
        self.horizontalLayout_9.addWidget(self.widget_drag)
        self.pushButton_windowminimized = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_windowminimized.setObjectName("pushButton_windowminimized")
        self.horizontalLayout_9.addWidget(self.pushButton_windowminimized)
        self.pushButton_windowMaximized = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_windowMaximized.setObjectName("pushButton_windowMaximized")
        self.horizontalLayout_9.addWidget(self.pushButton_windowMaximized)
        self.pushButton_close = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_close.setObjectName("pushButton_close")
        self.horizontalLayout_9.addWidget(self.pushButton_close)
        ...
        self.gridLayout_2.addWidget(self.pushButton_addCheck, 1, 2, 1, 1)
        self.comboBox_LSBMSB = QtWidgets.QComboBox(self.groupBox_2)
        self.comboBox_LSBMSB.setObjectName("comboBox_LSBMSB")
        self.comboBox_LSBMSB.addItem("")
        self.comboBox_LSBMSB.addItem("")
        self.gridLayout_2.addWidget(self.comboBox_LSBMSB, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "ComMonitor"))
        self.pushButton_windowminimized.setText(_translate("MainWindow", "-"))
        self.pushButton_windowMaximized.setText(_translate("MainWindow", "□"))
        ...
        self.comboBox_check.setItemText(0, _translate("MainWindow", "CRC32"))
        self.comboBox_check.setItemText(1, _translate("MainWindow", "CRC16/MODBUS"))
        self.comboBox_check.setItemText(2, _translate("MainWindow", "CRC8"))
        self.label_7.setText(_translate("MainWindow", "  发送区1"))
        self.pushButton_addCheck.setText(_translate("MainWindow", "添加校验"))
        self.comboBox_LSBMSB.setItemText(0, _translate("MainWindow", "LSB"))
        self.comboBox_LSBMSB.setItemText(1, _translate("MainWindow", "MSB"))
